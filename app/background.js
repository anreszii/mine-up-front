(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("electron-serve"), require("electron-store"), require("minecraft-launcher-core"));
	else if(typeof define === 'function' && define.amd)
		define(["electron-serve", "electron-store", "minecraft-launcher-core"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("electron-serve"), require("electron-store"), require("minecraft-launcher-core")) : factory(root["electron-serve"], root["electron-store"], root["minecraft-launcher-core"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(global, (__WEBPACK_EXTERNAL_MODULE_electron_serve__, __WEBPACK_EXTERNAL_MODULE_electron_store__, __WEBPACK_EXTERNAL_MODULE_minecraft_launcher_core__) => {
...
"use strict";
module.exports = __WEBPACK_EXTERNAL_MODULE_minecraft_launcher_core__;
...
/* harmony import */ var minecraft_launcher_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! minecraft-launcher-core */ "minecraft-launcher-core");
/* harmony import */ var minecraft_launcher_core__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(minecraft_launcher_core__WEBPACK_IMPORTED_MODULE_4__);
...
const runMC = (token, minRAM, maxRAM, event, version) => {
  const launcher = new minecraft_launcher_core__WEBPACK_IMPORTED_MODULE_4__.Client();
  const opts = {
    clientPackage: null,
    authorization: token,
    root: "./minecraft",
...
const logIn = (event, username, password, minRAM, maxRAM, version) => {
  if (password) {
    minecraft_launcher_core__WEBPACK_IMPORTED_MODULE_4__.Authenticator.getAuth(username, password).then(token => runMC(token, minRAM, maxRAM, event, version)).catch(err => {
      console.log(err);
      event.reply("loginError", {
        error: "Login/passwordword Error"
      });
    });
  } else {
    minecraft_launcher_core__WEBPACK_IMPORTED_MODULE_4__.Authenticator.getAuth(username).then(token => runMC(token, minRAM, maxRAM, event, version));
  }
};
(async () => {
...
electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.on("memory", (event, arg) => {
  console.log(event, arg.maxRAM, arg.minRAM);
});
electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.on("logIn", (event, arg) => {
